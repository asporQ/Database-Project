<nav x-data="{ open: false }" class="bg-[#292827] border-b border-gray-100 h-16 shadow-md">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-full">
        ...
        <!-- Navigation Links -->
        <div class="hidden sm:flex sm:items-center sm:gap-8 gap-8">
            <a href="{{ url('products') }}" class="text-white hover:text-[#F3B917]">PRODUCT</a>
            <a href="{{ url('categories') }}" class="text-white hover:text-[#F3B917]">CATEGORY</a>
            <a href="{{ url('sales') }}" class="text-white hover:text-[#F3B917]">SALES</a>
            <a href="{{ url('contact') }}" class="text-white hover:text-[#F3B917]">CONTACT</a>
        </div>
        <div class="sm:hidden">
                    ...
                    <button
                        ...
                        <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M3 3h18M3 12h18M3 21h18"></path>
                        </svg>
                    </button>
                </x-slot>
                <x-slot name="content">
                    <x-dropdown-link :href="url('products')"
                    ...
                    <x-dropdown-link :href="url('sales')"
                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                        {{ __('SALES') }}
                    </x-dropdown-link>
