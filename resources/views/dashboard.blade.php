<x-app-layout>
    <div class="relative main sample-header-section">
        ...
        <div class="absolute inset-0  bg-opacity-50 flex flex-col items-center justify-center space-y-4">
            ...
            <span class="text-yellowy text-xl animate__animated animate__fadeInUp animate__delay-1s font-semibold">SO
                FAR SO
                GOOD</span>
    ...
    <div class="py-16 ">
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mt-8">
                <a href="{{ url('products') }}"
                    class="bg-yellowy text-black px-6 py-3 rounded-full font-semibold hover:bg-yellow-600 transition duration-300">More
                    Products</a>
            </div>
        </div>
    </div>
