<x-app-layout>
    <x-slot name="header">
        <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8 flex justify-center">
            <h2 class="font-bold font-inter text-4xl text-center text-gray-800">Contact Us</h2>
        </div>
    </x-slot>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="google-map">
                <iframe
                    ...
                    width="100%"
                    height="450"
                    style="border:0; border-radius: 12px; box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1);"
                    allowfullscreen=""
                    loading="lazy"
            ...
            <div class="contact-info bg-white shadow-lg rounded-lg p-6">
                <h3 class="text-3xl font-bold text-center text-gray-700 mb-8">Get in Touch</h3>
                <div class="space-y-6">
                    <div class="flex items-center">
                        <span class="font-semibold text-lg text-gray-600 mr-4">Phone:</span>
